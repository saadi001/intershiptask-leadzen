...
const Users = () => {
     ...
     return (
          <div className='w-full min-h-screen flex items-center  bg-slate-300/30'>
               <div className='w-full'>
                    <div className='mx-2 sm:mx-6 md:mx-12 lg:max-w-5xl lg:mx-auto py-5'>
                         {
                              currentPosts.map(user => <div key={user.id} className='mb-8 py-5 md:py-8 px-3 md:px-8 bg-white rounded-md shadow-sm'>
